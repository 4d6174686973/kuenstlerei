  ...
  return (
    <main className="max-w-3xl min-h-screen">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4">I. Name und Anschrift des Verantwortlichen</h2>
        <p className="mb-4">
        ...
        <p>
          ...
          52146 Würselen<br />
          Deutschland<br />
          Tel.: 0171 595 2908<br />
          E-Mail: kunstakademie@online.de<br />
          Website: www.kunstakademie.art
        </p>
      </section>

      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4">II. Allgemeines zur Datenverarbeitung</h2>

        <h3 className="text-xl font-bold mt-6 mb-2">1. Umfang der Verarbeitung personenbezogener Daten</h3>
        <p className="mb-4">
          Wir verarbeiten personenbezogene Daten unserer Nutzer grundsätzlich nur, soweit dies zur Bereitstellung einer funktionsfähigen Website sowie unserer Inhalte und Leistungen erforderlich ist. Die Verarbeitung personenbezogener Daten unserer Nutzer erfolgt regelmäßig nur nach Einwilligung des Nutzers. Eine Ausnahme gilt in solchen Fällen, in denen eine vorherige Einholung einer Einwilligung aus tatsächlichen Gründen nicht möglich ist und die Verarbeitung der Daten durch gesetzliche Vorschriften gestattet ist.
        </p>

        <h3 className="text-xl font-bold mt-6 mb-2">2. Rechtsgrundlage für die Verarbeitung personenbezogener Daten</h3>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-bold mt-6 mb-2">3. Datenlöschung und Speicherdauer</h3>
        <p className="mb-4">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4">III. Bereitstellung der Website und Erstellung von Logfiles</h2>
        
        <h3 className="text-xl font-bold mt-6 mb-2">1. Beschreibung und Umfang der Datenverarbeitung</h3>
        <p className="mb-2">
        ...
        <h3 className="text-xl font-bold mt-6 mb-2">2. Rechtsgrundlage für die Datenverarbeitung</h3>
        <p className="mb-4">
          Rechtsgrundlage für die vorübergehende Speicherung der Daten und der Logfiles ist Art. 6 Abs. 1 lit. f DSGVO.
        </p>

        <h3 className="text-xl font-bold mt-6 mb-2">3. Zweck der Datenverarbeitung</h3>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-bold mt-6 mb-2">4. Dauer der Speicherung</h3>
        <p className="mb-4">
            Die Daten werden gelöscht, sobald sie für die Erreichung des Zweckes ihrer Erhebung nicht mehr erforderlich sind. Im Falle der Erfassung der Daten zur Bereitstellung der Website ist dies der Fall, wenn die jeweilige Sitzung beendet ist. Im Falle der Speicherung der Daten in Logfiles ist dies nach spätestens sieben Tagen der Fall. Eine darüberhinausgehende Speicherung ist möglich. In diesem Fall werden die IP-Adressen der Nutzer gelöscht oder verfremdet, sodass eine Zuordnung des aufrufenden Clients nicht mehr möglich ist.
        </p>

        <h3 className="text-xl font-bold mt-6 mb-2">5. Widerspruchs- und Beseitigungsmöglichkeit</h3>
        <p className="mb-4">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4">IV. Verwendung von Cookies</h2>

        <h3 className="text-xl font-bold mt-6 mb-2">1. Beschreibung und Umfang der Datenverarbeitung</h3>
        <p className="mb-2">Unsere Webseite verwendet Cookies. Bei Cookies handelt es sich um Textdateien, die im Internetbrowser bzw. vom Internetbrowser auf dem Computersystem des Nutzers gespeichert werden. Ruft ein Nutzer eine Website auf, so kann ein Cookie auf dem Betriebssystem des Nutzers gespeichert werden. Dieser Cookie enthält eine charakteristische Zeichenfolge, die eine eindeutige Identifizierung des Browsers beim erneuten Aufrufen der Website ermöglicht.</p>
        <p className="mb-2">Wir setzen Cookies ein, um unsere Website nutzerfreundlicher zu gestalten. Einige Elemente unserer Internetseite erfordern es, dass der aufrufende Browser auch nach einem Seitenwechsel identifiziert werden kann.</p>
        <p className="mb-2">In den Cookies werden dabei folgende Daten gespeichert und übermittelt:</p>
        ...
        <h3 className="text-xl font-bold mt-6 mb-2">4. Dauer der Speicherung, Widerspruchs- und Beseitigungsmöglichkeit</h3>
        <p className="mb-2">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-bold mb-4">V. E-Mail-Kontakt und Kontaktformular</h2>

        <h3 className="text-xl font-bold mt-6 mb-2">1. Beschreibung und Umfang der Datenverarbeitung</h3>
        <p className="mb-2">
            Eine Kontaktaufnahme über die bereitgestellte E-Mail-Adresse, sowie das Kontaktformular ist möglich. In diesem Fall werden die mit der E-Mail übermittelten personenbezogenen Daten des Nutzers gespeichert.Es erfolgt in diesem Zusammenhang keine Weitergabe der Daten an Dritte. Die Daten werden ausschließlich für die Verarbeitung der Konversation verwendet.
        </p>
        ...
        <h3 className="text-xl font-bold mt-6 mb-2">5. Widerspruchs- und Beseitigungsmöglichkeit</h3>
        <p className="mb-2">
            Der Nutzer hat jederzeit die Möglichkeit, seine Einwilligung zur Verarbeitung der personenbezogenen Daten zu widerrufen. Nimmt der Nutzer per E-Mail Kontakt mit uns auf, so kann er der Speicherung seiner personenbezogenen Daten jederzeit widersprechen. In einem solchen Fall kann die Konversation nicht fortgeführt werden. Der Widerruf der Einwilligung und der Widerspruch der Speicherung sind jederzeit per E-Mail möglich. Alle personenbezogenen Daten, die im Zuge der Kontaktaufnahme gespeichert wurden, werden in diesem Fall gelöscht.
        </p>

      </section>

        <section className="mb-10">
            <h2 className="text-2xl font-bold mb-4">VI. Rechte der betroffenen Person</h2>
            <p className="mb-4">
            Werden personenbezogene Daten von Ihnen verarbeitet, sind Sie Betroffener i.S.d. DSGVO und es stehen Ihnen folgende Rechte gegenüber dem Verantwortlichen zu:
            </p>

            <h3 className="text-xl font-bold mt-6 mb-2">1. Auskunftsrecht</h3>
            <p className="mb-2">
            ...
            <h3 className="text-xl font-bold mt-6 mb-2">2. Recht auf Berichtigung</h3>
            <p className="mb-4">
            Sie haben ein Recht auf Berichtigung und/oder Vervollständigung gegenüber dem Verantwortlichen, sofern die verarbeiteten personenbezogenen Daten, die Sie betreffen, unrichtig oder unvollständig sind. Der Verantwortliche hat die Berichtigung unverzüglich vorzunehmen.
            </p>

            <h3 className="text-xl font-bold mt-6 mb-2">3. Recht auf Einschränkung der Verarbeitung</h3>
            <p className="mb-2">
            ...
            <h3 className="text-xl font-bold mt-6 mb-2">4. Recht auf Löschung</h3>
            <h4 className="font-bold mb-2">a) Löschungspflicht</h4>
            <p className="mb-2">
            ...
            <h4 className="font-bold mb-2">b) Information an Dritte</h4>
            <p className="mb-4">
            Hat der Verantwortliche die Sie betreffenden personenbezogenen Daten öffentlich gemacht und ist er gem. Art. 17 Abs. 1 DSGVO zu deren Löschung verpflichtet, so trifft er unter Berücksichtigung der verfügbaren Technologie und der Implementierungskosten angemessene Maßnahmen, auch technischer Art, um für die Datenverarbeitung Verantwortliche, die die personenbezogenen Daten verarbeiten, darüber zu informieren, dass Sie als betroffene Person von ihnen die Löschung aller Links zu diesen personenbezogenen Daten oder von Kopien oder Replikationen dieser personenbezogenen Daten verlangt haben.
            </p>
            <h4 className="font-bold mb-2">c) Ausnahmen</h4>
            <p className="mb-2">Das Recht auf Löschung besteht nicht, soweit die Verarbeitung erforderlich ist:</p>
            <ol className="list-decimal ml-6 mb-4 space-y-1">
            ...
            <h3 className="text-xl font-bold mt-6 mb-2">5. Recht auf Unterrichtung</h3>
            <p className="mb-4">
            Haben Sie das Recht auf Berichtigung, Löschung oder Einschränkung der Verarbeitung gegenüber dem Verantwortlichen geltend gemacht, ist dieser verpflichtet, allen Empfängern, denen die Sie betreffenden personenbezogenen Daten offengelegt wurden, diese Berichtigung oder Löschung der Daten oder Einschränkung der Verarbeitung mitzuteilen, es sei denn, dies erweist sich als unmöglich oder ist mit einem unverhältnismäßigen Aufwand verbunden. Ihnen steht gegenüber dem Verantwortlichen das Recht zu, über diese Empfänger unterrichtet zu werden.
            </p>

            <h3 className="text-xl font-bold mt-6 mb-2">6. Recht auf Datenübertragbarkeit</h3>
            <p className="mb-2">
            ...
            <h3 className="text-xl font-bold mt-6 mb-2">7. Widerspruchsrecht</h3>
            <p className="mb-4">
            ...
            <h3 className="text-xl font-bold mt-6 mb-2">8. Recht auf Widerruf der datenschutzrechtlichen Einwilligungserklärung</h3>
            <p className="mb-4">
            Sie haben das Recht, Ihre datenschutzrechtliche Einwilligungserklärung jederzeit zu widerrufen. Durch den Widerruf der Einwilligung wird die Rechtmäßigkeit der aufgrund der Einwilligung bis zum Widerruf erfolgte Verarbeitung nicht berührt.
            </p>

            <h3 className="text-xl font-bold mt-6 mb-2">9. Automatisierte Entscheidung im Einzelfall einschließlich Profiling</h3>
            <p className="mb-2">
            ...
            <h3 className="text-xl font-bold mt-6 mb-2">10. Recht auf Beschwerde bei einer Aufsichtsbehörde</h3>
            <p className="mb-4">
        ...
        <section className="mb-10">
            <h2 className="text-2xl font-bold mb-4">VII. Datensicherheit</h2>
            <p>
